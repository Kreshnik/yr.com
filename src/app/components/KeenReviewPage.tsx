...
import { Star, CheckCircle2, CreditCard, Users, DollarSign, Shield, Award } from 'lucide-react';
...
export function KeenReviewPage({ onBack }: KeenReviewPageProps) {
  return (
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#F3E8FF] via-white to-[#E9D5FF]">
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#4A00BF]">
            Delivers high quality readings for a long time.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-[#4A00BF]/10 via-[#A855F7]/5 to-[#4A00BF]/5 rounded-2xl p-6 sm:p-10 border-2 border-[#4A00BF]/20 shadow-xl">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#4A00BF] mb-6 text-center">
              Convenient Keen.com Summary
            </h2>
            <div className="space-y-4 text-base sm:text-lg text-gray-700 leading-relaxed">
              <p>
                A long-standing leader, Keen.com connects users with over <span className="font-bold text-[#4A00BF]">1,300 trusted advisors</span>. New users can get started with an attractive introductory offer of <span className="font-bold text-[#4A00BF]">5 minutes for just $1</span>, making it a reliable choice for in-depth spiritual guidance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-[#F3E8FF]">
        <div className="max-w-5xl mx-auto space-y-8">
          <ReviewSection
            ...
            title="Keen.com Reader Credibility"
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#F3E8FF] to-[#E9D5FF]">
        <div className="max-w-4xl mx-auto text-center space-y-6 bg-gradient-to-br from-[#4A00BF] via-[#7C3AED] to-[#A855F7] rounded-3xl p-8 sm:p-12 shadow-2xl">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white">
            Ready to Experience Keen?
          </h2>
          <p className="text-lg sm:text-xl text-white/90 max-w-2xl mx-auto">
            Get your first 5 minutes for only $1. Connect with over 1,300 trusted advisors today.
          </p>
          <Button 
            size="lg" 
