...
function QuoteChip({ text, author }: { text: string; author: string }) {
  return (
    <div className="flex-shrink-0 w-72 bg-white border border-purple-100 rounded-2xl px-5 py-4 shadow-sm mx-2.5">
...
export function MovingTestimonials() {
  return (
    <div className="w-full overflow-hidden py-2 space-y-3 select-none">
      {/* Row 1 — moves left */}
