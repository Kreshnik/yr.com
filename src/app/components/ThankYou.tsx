...
import { Sparkles, Heart, ShieldCheck, CheckCircle2, Users, CreditCard, Infinity, Zap, CircleDot } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-4 sm:p-5 shadow-sm border border-[#4A00BF]/10">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-base sm:text-lg text-gray-700 leading-relaxed pt-2">
                    Choose any available psychic or tarot reader who resonates with you
                  </p>
                </div>
              </div>
              <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-4 sm:p-5 shadow-sm border border-[#4A00BF]/10">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-[#4A00BF] to-[#A855F7] flex items-center justify-center relative">
                    <ShieldCheck className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  </div>
                  <p className="text-base sm:text-lg text-gray-700 leading-relaxed pt-2">
                    <strong>No credit card required</strong> —completely free for 3 minutes
                  </p>
                </div>
              </div>
              <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-4 sm:p-5 shadow-sm border border-[#4A00BF]/10">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-base sm:text-lg text-gray-700 leading-relaxed pt-2">
                    <strong>No subscription, no commitment</strong> —just genuine guidance
                  </p>
                </div>
              </div>
              <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-4 sm:p-5 shadow-sm border border-[#4A00BF]/10">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-base sm:text-lg text-gray-700 leading-relaxed pt-2">
                    <strong>Start immediately</strong> —your reader is waiting
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <span className="text-[#4A00BF] text-xl">✓</span>
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                <span className="text-[#4A00BF] text-xl">✓</span>
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  <strong>Stop suffering alone in your confusion</strong> —connect with a guide who's walked thousands of women through exactly what you're facing
                </p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-[#4A00BF] text-xl">✓</span>
